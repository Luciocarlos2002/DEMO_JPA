...
public class AreaController implements Serializable {
    ...
    @EJB
    private modelo.dao.AreaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/vista").getString("AreaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/vista").getString("AreaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/vista").getString("AreaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class AreaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Area) {
                Area o = (Area) object;
                return getStringKey(o.getIdare());
            } else {
